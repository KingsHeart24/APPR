...
namespace Part_2.Controllers
{
    public class HomeController : Controller
    {
        ...
        string conn = "Server=tcp:djpromosimon.database.windows.net,1433;Initial Catalog=DjPromo;Persist Security Info=False;User ID=admin1;Password=Si241998;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30";
        ...
        public ActionResult LogIn(UserTable user)
        {
            ...
            SqlConnection bv = new SqlConnection("Data Source=djpromosimon.database.windows.net;Initial Catalog=DjPromo;User ID=admin1;Password=Si241998;Connect Timeout=30;Encrypt=True;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False");
